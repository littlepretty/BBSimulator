...
The responsiveness of system would be greatly improved and
user job would suffer less wait time. 
The burst buffer and compute node will be released right after the job enters next phase,
and become available to the following job. Thus, the system utilization would be improved.
As Cerberus could take advantage of the parallelism of jobs in different phases,
the throughput of system would get improved.
