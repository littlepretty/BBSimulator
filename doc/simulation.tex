...
\begin{table}[!t] 
        ...
        \begin{tabular}{lccc}
                \hline
                 & FCFS & Max BB & Max \#Task \\
                \hline
                \hline
                Simulation Run Time / seconds & 6.59 & 246.87 & 207.42 \\
                Optimization Time / seconds & x & 241.11 & 201.75 \\
                \#Optimizations & x & 8702 & 9114 \\
                \hline
        \end{tabular}
\end{table}
...
\begin{table}[!t] 
        ...
        \begin{tabular}{lccc}
                ...
                Optimization Time / seconds & 241.11 & 201.75 \\
                \#Optimizations & 8702 & 9114 \\
                \hline
        \end{tabular}
\end{table}
