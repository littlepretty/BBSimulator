        ...
        \begin{align}
                ...
                \left\{
                        \begin{array}{l}
                                ...
                                \max \{ dp(i-1, w), dp(i-1, w-bb\_sin_i) + bb\_sin_i \}, \textit{ if $bb\_sin_i \leq w$}
                        \end{array} 
                \right.
                ...
                \left\{
                        \begin{array}{l}
                                0, \textit{ if $i=0$ } \\ [1em]
                                dp(i-1, w), \textit{ if $bb\_sin_i > w$} \\ [1em]
                                \max \{ dp(i-1, w), dp(i-1, w-bb\_sin_i) + 1 \}, \textit{ if $bb\_sin_i \leq w$}
                        \end{array} 
                \right.
                ...
                \left\{
                        \begin{array}{l}
                                ...
                                \max \{ dp(i-1, c, w), dp(i-1, c - c_i, w-bb\_sin_i) + 1 \}, \textit{ if $c_i \leq c$ and $bb\_sin_i \leq w$}
                        \end{array} 
                \right.
