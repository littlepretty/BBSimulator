...
2) our 3-phase model and dynamic programming solution further benefit burst buffer equipped system.
...
1) burst buffer node can accelerate the execution pipeline of all task, thus improving the task response time
2) our 3-phase model and dynamic programming solution further benefit burst buffer equipped system.
\end{abstract}
